                ...
                function(err, db) {
                    ...
                    try {
                        users.forEach(user => {
                            ...
                            // Number of minutes randomly generated to subtract from current time. 
                            const mins = Math.floor(Math.random() * 5) + 1;
                            const currentTime = new Date().getTime();

                            // Current time updated to generated random minutes ago 
...
async function changeUsersActivity(){
    ...
    try {
        ...
        console.info(`\n---------- ${updatedData}\n`);
        return 'Last activity change process done.';
    } catch (error) {
        throw error;
    }
};
...
exports.activityService = {
    changeUsersActivity : changeUsersActivity
};